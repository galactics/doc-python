...
texinfo_documents = [
  ('index', 'doc', u'doc Documentation',
   u'Jules DAVID', 'doc', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'doc'
epub_author = u'Jules DAVID'
epub_publisher = u'Jules DAVID'
epub_copyright = u'2015, Jules DAVID'
...
intersphinx_mapping = {
    ...
    'fabric': ('http://docs.fabfile.org/en/1.10/', None),
}
